...
using OrderApi.Web.Startup.ExternalLoginInfoProviders;
...
namespace OrderApi.Web.Startup
{
    ...
    public class OrderApiWebHostModule : AbpModule
    {
        private readonly IWebHostEnvironment _env;
        private readonly IConfigurationRoot _appConfiguration;

        public OrderApiWebHostModule(
        ...
        {
            IocManager.RegisterAssemblyByConvention(typeof(OrderApiWebHostModule).GetAssembly());
        }
