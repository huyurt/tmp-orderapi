...
using OrderApi.Authorization.Ldap;
using OrderApi.Authorization.Roles;
using OrderApi.Authorization.Users;
using OrderApi.Chat;
using OrderApi.Configuration;
using OrderApi.DashboardCustomization.Definitions;
using OrderApi.Debugging;
using OrderApi.DynamicEntityProperties;
using OrderApi.Features;
using OrderApi.Friendships;
using OrderApi.Friendships.Cache;
using OrderApi.Localization;
using OrderApi.MultiTenancy;
using OrderApi.Net.Emailing;
using OrderApi.Notifications;
using OrderApi.WebHooks;
...
namespace OrderApi
{
    ...
    public class OrderApiCoreModule : AbpModule
    {
        public override void PreInitialize()
        {
            ...
            OrderApiLocalizationConfigurer.Configure(Configuration.Localization);
            ...
            Configuration.MultiTenancy.IsEnabled = OrderApiConsts.MultiTenancyEnabled;
            ...
            Configuration.ReplaceService<IMailKitSmtpBuilder, OrderApiMailKitSmtpBuilder>(DependencyLifeStyle.Transient);
            ...
            Configuration.ReplaceService(typeof(IEmailSenderConfiguration), () =>
            {
                Configuration.IocManager.IocContainer.Register(
                    Component.For<IEmailSenderConfiguration, ISmtpEmailSenderConfiguration>()
                             .ImplementedBy<OrderApiSmtpEmailSenderConfiguration>()
                             .LifestyleTransient()
                );
            });
        ...
        {
            IocManager.RegisterAssemblyByConvention(typeof(OrderApiCoreModule).GetAssembly());
        }
