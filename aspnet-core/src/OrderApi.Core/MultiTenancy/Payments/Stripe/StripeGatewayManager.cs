...
{
    public class StripeGatewayManager : OrderApiServiceBase,
        ...
        ITransientDependency
    {
        ...
        public static string ProductName = "OrderApi";
        ...
        {
            return editionName + "_" + paymentPeriodType + "_" + OrderApiConsts.Currency;
        }
