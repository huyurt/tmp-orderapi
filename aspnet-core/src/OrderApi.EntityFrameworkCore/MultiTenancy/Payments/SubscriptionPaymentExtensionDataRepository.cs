...
using OrderApi.EntityFrameworkCore.Repositories;

namespace OrderApi.MultiTenancy.Payments
{
    public class SubscriptionPaymentExtensionDataRepository : OrderApiRepositoryBase<SubscriptionPaymentExtensionData, long>,
        ISubscriptionPaymentExtensionDataRepository
    {
        public SubscriptionPaymentExtensionDataRepository(IDbContextProvider<OrderApiDbContext> dbContextProvider) : base(dbContextProvider)
        {
        }
