...
namespace OrderApi.Migrations
{
    ...
    [Migration("20220221203642_Musteri_Siparis_SiparisUrun")]
    partial class Musteri_Siparis_SiparisUrun
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("OrderApi.Authorization.Delegation.UserDelegation", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
            ...
            modelBuilder.Entity("OrderApi.MultiTenancy.Payments.SubscriptionPaymentExtensionData", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
            ...
            modelBuilder.Entity("OrderApi.Musteri.Musteri", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("OrderApi.Siparis.Sepet", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("OrderApi.Siparis.SepetUrun", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Abp.Authorization.Roles.RoleClaim", b =>
                {
                    b.HasOne("OrderApi.Authorization.Roles.Role", null)
                        .WithMany("Claims")
            ...
            modelBuilder.Entity("Abp.Authorization.Users.UserClaim", b =>
                {
                    b.HasOne("OrderApi.Authorization.Users.User", null)
                        .WithMany("Claims")
            ...
            modelBuilder.Entity("OrderApi.Siparis.Sepet", b =>
                {
                    b.HasOne("OrderApi.Musteri.Musteri", "MusteriFk")
                        .WithMany("Sepetler")
            ...
            modelBuilder.Entity("OrderApi.Siparis.SepetUrun", b =>
                {
                    b.HasOne("OrderApi.Siparis.Sepet", "SepetFk")
                        .WithMany("SepetUrunler")
                        .HasForeignKey("SepetId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.Navigation("SepetFk");
                });
