...
namespace OrderApi.Web.Startup
{
    ...
    public class OrderApiWebMvcModule : AbpModule
    {
        private readonly IConfigurationRoot _appConfiguration;

        public OrderApiWebMvcModule(IWebHostEnvironment env)
        {
        ...
        {
            IocManager.RegisterAssemblyByConvention(typeof(OrderApiWebMvcModule).GetAssembly());
        }
