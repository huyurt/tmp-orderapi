...
namespace OrderApi.Web.Public.Startup
{
    [DependsOn(
        typeof(OrderApiWebCoreModule)
    )]
    public class OrderApiWebFrontEndModule : AbpModule
    {
        private readonly IConfigurationRoot _appConfiguration;

        public OrderApiWebFrontEndModule(IWebHostEnvironment env, OrderApiEntityFrameworkCoreModule abpZeroTemplateEntityFrameworkCoreModule)
        {
        ...
        {
            IocManager.RegisterAssemblyByConvention(typeof(OrderApiWebFrontEndModule).GetAssembly());
        }
    }
}
