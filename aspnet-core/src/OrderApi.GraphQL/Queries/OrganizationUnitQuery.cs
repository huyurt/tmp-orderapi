...
using OrderApi.Core.Base;
using OrderApi.Core.Extensions;
using OrderApi.Dto;
using OrderApi.Types;

namespace OrderApi.Queries
{
    public class OrganizationUnitQuery : OrderApiQueryBase<ListGraphType<OrganizationUnitType>, List<OrganizationUnitDto>>
    {
