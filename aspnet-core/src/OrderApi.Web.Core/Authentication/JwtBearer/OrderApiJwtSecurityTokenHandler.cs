...
namespace OrderApi.Web.Authentication.JwtBearer
{
    public class OrderApiJwtSecurityTokenHandler : ISecurityTokenValidator
    {
        private readonly JwtSecurityTokenHandler _tokenHandler;

        public OrderApiJwtSecurityTokenHandler()
        {
