...
using OrderApi.Web.Authentication.JwtBearer;
using OrderApi.Web.Authentication.TwoFactor;
using OrderApi.Web.Chat.SignalR;
using OrderApi.Web.Common;
using OrderApi.Web.Configuration;
using OrderApi.Web.DashboardCustomization;

namespace OrderApi.Web
{
    [DependsOn(
        typeof(OrderApiApplicationModule),
        typeof(OrderApiEntityFrameworkCoreModule),
    ...
    public class OrderApiWebCoreModule : AbpModule
    {
        private readonly IWebHostEnvironment _env;
        private readonly IConfigurationRoot _appConfiguration;

        public OrderApiWebCoreModule(IWebHostEnvironment env)
        {
            _env = env;
        ...
        public override void PreInitialize()
        {
            ...
            Configuration.Modules.AbpAspNetCore()
                .CreateControllersForAppServices(
                    typeof(OrderApiApplicationModule).GetAssembly()
                );
        ...
        {
            IocManager.RegisterAssemblyByConvention(typeof(OrderApiWebCoreModule).GetAssembly());
        }
        ...
        public override void PostInitialize()
        {
            ...
            IocManager.Resolve<ApplicationPartManager>()
                .AddApplicationPartsIfNotAddedBefore(typeof(OrderApiWebCoreModule).Assembly);
        }
