...
using OrderApi.Auditing.Exporting;
using OrderApi.Authorization;
using OrderApi.Authorization.Users;
using OrderApi.Dto;
using OrderApi.EntityHistory;
using EntityHistoryHelper = OrderApi.EntityHistory.EntityHistoryHelper;

namespace OrderApi.Auditing
{
    [DisableAuditing]
    [AbpAuthorize(AppPermissions.Pages_Administration_AuditLogs)]
    public class AuditLogAppService : OrderApiAppServiceBase, IAuditLogAppService
    {
