...
{
    public class SessionAppService : OrderApiAppServiceBase, ISessionAppService
    {
            ...
            return await _unitOfWorkManager.WithUnitOfWorkAsync(async () =>
            {
                var output = new GetCurrentLoginInformationsOutput
                {
                    Application = new ApplicationInfoDto
                    {
                        ...
                        Currency = OrderApiConsts.Currency,
                        CurrencySign = OrderApiConsts.CurrencySign,
                        AllowTenantsToChangeEmailSettings = OrderApiConsts.AllowTenantsToChangeEmailSettings,
