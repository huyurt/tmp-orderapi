...
using OrderApi.Authorization.Users.Profile.Cache;
...
using OrderApi.Timing;

namespace OrderApi.Authorization.Users.Profile
{
    [AbpAuthorize]
    public class ProfileAppService : OrderApiAppServiceBase, IProfileAppService
    {
        ...
        public async Task<CurrentUserProfileEditDto> GetCurrentUserProfileForEdit()
        {
            ...
            userProfileEditDto.QrCodeSetupImageUrl = user.GoogleAuthenticatorKey != null
                ? _googleTwoFactorAuthenticateService.GenerateSetupCode("OrderApi",
