...
using OrderApi.Authorization.Accounts.Dto;
...
using OrderApi.Authorization.Users.Profile.Dto;
using OrderApi.Chat;
...
using OrderApi.Friendships.Dto;
using OrderApi.Localization.Dto;
...
using OrderApi.Notifications.Dto;
...
namespace OrderApi
{
    internal static class CustomDtoMapper
    {
        ...
        {
            configuration.CreateMap<CreateOrEditMusteriDto, Musteri.Musteri>().ReverseMap();
            configuration.CreateMap<MusteriDto, Musteri.Musteri>().ReverseMap();
            
            configuration.CreateMap<CreateOrEditSepetDto, Sepet>().ReverseMap();
            configuration.CreateMap<SepetDto, Sepet>().ReverseMap();
            
            configuration.CreateMap<CreateOrEditSepetUrunDto, SepetUrun>().ReverseMap();
            configuration.CreateMap<SepetUrunDto, SepetUrun>().ReverseMap();
