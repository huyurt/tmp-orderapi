...
using OrderApi.MultiTenancy.HostDashboard;
...
namespace OrderApi.Tests.HostDashboard
{
    ...
    public class HostDashboardAppService_Tests : AppTestBase
    {
        ...
        private void CreatePaidPayment(OrderApiDbContext context, SubscriptionPayment subscriptionPayment)
        {
